...
public class MT103XMLGenerator implements IXMLGenerator {
	...
	public String getXML(Object mxObject) throws MTConversionException {
        ...
        try {
             ...
             */
            JAXBElement<Document> jaxbElement = new JAXBElement<Document>( new QName( Constants.PACS008_XMLNS, "Document"),
                    Document.class,
                    document);
